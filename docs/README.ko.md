...
- 프로필 생성, 명시적 불러오기 및 레이아웃 변경 후 자동 저장
- 메인 창의 독립된 프로필 및 오버레이 조작 영역
...
Mabinogi Overlay는 [MIT License](../LICENSE)로 배포됩니다.

서드파티 의존성은 각자의 라이센스를 따릅니다. 현재 주요 NuGet 의존성인 WPF-UI와 Vortice 패키지도 MIT 라이센스입니다.
